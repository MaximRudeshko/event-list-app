...
infopackForm.addEventListener('submit', function (e) {
  ...
  var index = items.findIndex(function (item) {
    return item['id'] == IModal.getAttribute('data-index');
  });
  var iBlocks = document.querySelectorAll('.i');
  console.log(index);
  console.log(IModal);
  console.log(items[index]);

  for (var key in iFormState) {
    items[index]['i'][key] = iFormState[key];
  }

  if (items[index]['i']['departureDate'] != null && items[index]['i']['dateOfReceiving'] != null && items[index]['i']['pages'] != false && items[index]['i']['questionnaire'] != false && items[index]['i']['agreement'] != false && items[index]['i']['contactInfo'] != false && items[index]['i']['passportInfo'] != false && items[index]['i']['bankInfo'] != false && items[index]['i']['personalData'] != false && items[index]['i']['signature'] != false) {
    items[index]['i']['active'] = true;
    iBlocks.forEach(function (block) {
...
function addToLocalStorage(item) {
  var all = getItemsFromLocalStorage();
  all.push(item);
...
function renderItem(state, id) {
  ...
  var parentBlock = document.querySelector('.main__list');
...
function bindComment() {
  ...
  commentForms.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var commentBlock = e.target.closest('.comment__form');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global, module) {/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.concat */ "./node_modules/core-js/modules/es.array.concat.js");
...
/* harmony import */ var core_js_modules_es_date_to_json__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! core-js/modules/es.date.to-json */ "./node_modules/core-js/modules/es.date.to-json.js");
...
/* harmony import */ var core_js_modules_es_number_constructor__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! core-js/modules/es.number.constructor */ "./node_modules/core-js/modules/es.number.constructor.js");
/* harmony import */ var core_js_modules_es_number_constructor__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_number_constructor__WEBPACK_IMPORTED_MODULE_18__);
/* harmony import */ var core_js_modules_es_object_create__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! core-js/modules/es.object.create */ "./node_modules/core-js/modules/es.object.create.js");
/* harmony import */ var core_js_modules_es_object_create__WEBPACK_IMPORTED_MODULE_19___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_create__WEBPACK_IMPORTED_MODULE_19__);
...
/* harmony import */ var core_js_modules_web_url_to_json__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! core-js/modules/web.url.to-json */ "./node_modules/core-js/modules/web.url.to-json.js");
/* harmony import */ var core_js_modules_web_url_to_json__WEBPACK_IMPORTED_MODULE_29___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_url_to_json__WEBPACK_IMPORTED_MODULE_29__);
...
(function () {
  ...
  if (typeof define == 'function' && _typeof(__webpack_require__(/*! !webpack amd options */ "./node_modules/webpack/buildin/amd-options.js")) == 'object' && __webpack_require__(/*! !webpack amd options */ "./node_modules/webpack/buildin/amd-options.js")) {
    // Expose Lodash on the global object to prevent errors when Lodash is
    // loaded by a script tag in the presence of an AMD loader.
    // See http://requirejs.org/docs/errors.html#mismatch for more details.
    // Use `_.noConflict` to remove Lodash from the global object.
...
window.addEventListener('load', function () {
  ...
  searchInput.addEventListener('input', function () {
    ...
    var rows = document.querySelectorAll('.list__item');

    if (val != '') {
      rows.forEach(function (row) {
        var blocks = row.querySelectorAll('.list__search');
        var strings = [];
...
/***/ 0:
/*!************************************************************************************************************!*\
  !*** multi ./src/js/comments.js ./src/js/form.js ./src/js/lodash.js ./src/js/script.js ./src/js/search.js ***!
  \************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\Users\alesy\Desktop\RMS\list-app\src\js\comments.js */"./src/js/comments.js");
__webpack_require__(/*! C:\Users\alesy\Desktop\RMS\list-app\src\js\form.js */"./src/js/form.js");
__webpack_require__(/*! C:\Users\alesy\Desktop\RMS\list-app\src\js\lodash.js */"./src/js/lodash.js");
__webpack_require__(/*! C:\Users\alesy\Desktop\RMS\list-app\src\js\script.js */"./src/js/script.js");
module.exports = __webpack_require__(/*! C:\Users\alesy\Desktop\RMS\list-app\src\js\search.js */"./src/js/search.js");
